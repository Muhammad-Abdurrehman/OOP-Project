...
public:
 ...
 {
 int departmentno;
 cout << "Enter The Department Of Which Doctor Whose Appointment You 
Want To Check :\n";
 cout << "Press 1. Dental\n"
...
Appointment of 2 Doctor"; cin >> Named;
...
public:
 ...
 {
 int departmentno;
 cout << "Enter The Department of which doctor you want to Make an 
appointment:\n";
 cout << "Press 1. Dental\n"
 "Press 2. Accident & Emergency\n"
 "Press 3. Orthopaedics\n"
...
Appointment with Doctor 2"; cin >> Named;
 string username, password, Gender; int Age, Time;
 ofstream create;
 if (Named == 1)
 {
...
Appointment with Doctor 2"; cin >> Named;
 ...
 {
 int departmentno;
 cout << "Enter The Department of Which Doctor Data You Want To 
Remove:\n";
 cout << "Press 1. Dental\n"
 "Press 2. Accident & Emergency\n"
 "Press 3. Orthopaedics\n"
